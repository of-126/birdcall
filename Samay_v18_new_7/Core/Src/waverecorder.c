...
//static uint16_t RecBuf[16*2];/* PCM stereo samples are saved in RecBuf */
//static uint16_t InternalBuffer[128];
...
//{
//  return HAL_I2S_Receive_DMA(&hAudioInI2s, pbuf, size);
//}
//
///**
...
//{
//  return HAL_I2S_DMAStop(&hAudioInI2s);
//}
//
///**
...
//  f_unlink ("REC_WAVE_NAME.wav");
//
//  /* Open the file to write on it */
//  if ((f_open(&WavFile, "REC_WAVE_NAME.wav", FA_CREATE_ALWAYS | FA_WRITE) != FR_OK))
//  {
//    while(1)
//    {
...
//
//  while(1)// check ref usb connected
//  {
